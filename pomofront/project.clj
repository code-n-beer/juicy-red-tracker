(defproject pomofront "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "pomofront.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main pomofront.server
  ...
  :cljsbuild {:builds
              {:app
               {:source-paths ["src/cljs"]
                ...
                ;; :figwheel {:on-jsload "pomofront.core/on-figwheel-reload"}

                :compiler {:main pomofront.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/pomofront.js"
